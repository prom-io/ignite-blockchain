...
import {RootChainService} from '../../contracts/rootChain.service';
import {Web3Service} from '../../contracts/web3.service';

@Injectable()
export class PlasmaSyncCron {
    private readonly logger = new Logger(PlasmaSyncCron.name);
    ...
    async handleCronSync() {
        try {
            this.logger.debug('=========== Sync with main net started! ===========');
            ...
            this.logger.debug('=========== Sync with main net completed! ===========');
        } catch (e) {
